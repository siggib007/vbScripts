...
AuditCmd(0)      = "show bgp neighbor-group Cisco_VNF configuration | i bfd"
AuditCmd(1)      = "show bgp neighbor-group Cisco_VNF-S1u configuration | i bfd"
AuditCmd(2)      = "show bgp neighbor-group Cisco_VNF-v6 configuration | i bfd"
AuditCmd(3)      = "show bgp neighbor-group Cisco_VNF-v6-bypass configuration | i bfd"
AuditCmd(4)      = "show bgp neighbor-group Cisco_VNF_OptIn configuration | i bfd"
...
Sub Main
	...
	dim strParts, strLine, objFileIn, objFileOut, host, ConCmd, fso, nError, strErr, strResult, strResultParts, strOut, strOutPath, objDevName, iLineCount, passwd, cmd, strTemp
	...
	While not objFileIn.atendofstream
		...
		If crt.Session.Connected Then
			...
			for each cmd in AuditCmd
				...
				objFileOut.writeline host & "," & strTemp(3) & "," & iLineCount
			next
			objDevName.close
			crt.Session.Disconnect
		else
