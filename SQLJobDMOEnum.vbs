Option Explicit 
Dim Job, oSQLServer, bUseIntegrated, txtServer, sUsername, sPasswd, LastStatus, CurrStatus, AgentStatus
...
If wscript.arguments.count > 2 Then
	...
	wscript.echo Now() & " Connecting to " & strServer & " using " & sUsername
Else
	sUsername = ""
	sPasswd = ""
	bUseIntegrated = true
